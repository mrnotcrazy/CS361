...
def test_new_village():
	...
	response = requests.post(f'{BASE_URL}/new_village')
...
def test_new_villager():
	...
	response = requests.post(f'{BASE_URL}/new_villager')
...
def test_villager_mod(villager_id):
	...
	response = requests.post(f'{BASE_URL}/villager_mod', json=data)
...
def test_add_event(villager_id):
	...
	response = requests.post(f'{BASE_URL}/add_event', json=data)
	print("Response:", response.json())
...
def test_undo_event(villager_id):
	...
	response = requests.post(f'{BASE_URL}/undo_event', json=data)
	print("Response:", response.json())
